...
Rather than relying on subjective impressions, evaluations are performed using documented criteria designed to produce consistent, reproducible, and evidence-based results.

## Purpose

The rubrics in this repository are designed to:
...
- **Major versions** may introduce changes to scoring methodology or evaluation criteria.
- **Minor versions** add new rubrics or clarify existing guidance without changing scoring behavior.
- **Patch versions** correct wording, examples, formatting, or documentation errors.
